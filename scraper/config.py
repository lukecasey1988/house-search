...
MANUAL_DUPLICATE_GROUPS = [
    ...
    ],  # £1,495,000 Monks Risborough - confirmed same property 23 Jul 2026 by
        # comparing individual room photos. Listed twice on Rightmove itself
        # under two different agents (Reaston Brown and Tim Russ & Co) with
        # very different marketing copy and even conflicting floor areas
        # (3,950 vs 5,654 sq ft) - a dual-agency listing, most likely. One of
        # these two IDs already auto-merges with a Reaston Brown listing via
        # image hash; this override links the second Rightmove ID into that
        # same group.
]
